...
/***/ function(module, exports, __webpack_require__) {
	...
	var task = _nodeSchedule2.default.scheduleJob('*/42 * * * *', function () {
	  var options = {
	    method: 'GET',
	    url: _constants.SERVER_URL + '/posts'
	  };
	  axios.get(_constants.SERVER_URL + '/posts').then(function (response) {
...
//# sourceMappingURL=0.fe66bff249a0aa1fc184.hot-update.js.map