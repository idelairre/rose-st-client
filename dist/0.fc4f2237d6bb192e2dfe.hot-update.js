...
/***/ function(module, exports, __webpack_require__) {
	...
	var cache = _nodeSchedule2.default.scheduleJob('30 * * * *', function () {
	  console.log('stuff');
	  // const options = {
	  //   method: 'GET',
	  //   url: `${SERVER_URL}/posts`
	  // };
	  // const posts = request(options);
	  // console.log(posts);
	  // fs.writeJsonSync('cache.json', posts);
	});
...
//# sourceMappingURL=0.fc4f2237d6bb192e2dfe.hot-update.js.map